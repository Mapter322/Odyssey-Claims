...
public class ConstantComponents {
    ...
    public static final Component CLAIM = Component.translatable("gui.cadmus.claim_map.claim");
    public static final Component UNCLAIM = Component.translatable("gui.cadmus.claim_map.unclaim");
    public static final Component FORCELOAD = Component.translatable("gui.cadmus.claim_map.forceload");
    public static final Component UNFORCELOAD = Component.translatable("gui.cadmus.claim_map.unforceload");
    ...
    public static final Component OUTPOST = Component.translatable("gui.cadmus.claim_map.outpost");
